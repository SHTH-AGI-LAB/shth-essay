...
export const UNIVERSITIES = [
  ...
  },
  {
    ...
    bonus: "논리적 구성, 합리적 사고,성찰적 적용, 반론과 재반론",
  },
  {
    name: "고려대",
    slug: "korea",
    ...
    bonus: "종합적 사고, 다양한 방법으로 논증, 창의력, 어휘력, 제시문 양이 많음",
  },
  {
    name: "광운대",
    slug: "kw",
    ...
    bonus: "핵심 키워드 사용, 출제자의 의도와 구성 그대로 따를 것",
  },
  {
    name: "단국대",
    slug: "dankook",
    ...
    gradingType: "100점제",
    criteria: {
      문제1: { desc: "3개 문제를 문단 바꿈으로 입력, 제시문 이해, 요약", weight: 55 },
      문제2: { desc: "3개 문제를 문단 바꿈으로 입력, 자료의 이해와 활용능력", weight: 45 },
    },
  ...
  },
  {
    ...
    gradingType: "100점제",
    criteria: {
      문제1: { desc: "2문제 문단바꿈으로 입력, 제시문 이해, 문제와 해결방안", weight: 30 },
      문제2: { desc: "2문제 문단바꿈으로 입력, 비판적 사고와 해결방안", weight: 30 },
      문제3: { desc: "2문제 문단바꿈으로 입력, 사회적 의의, 해결방안", weight: 40 },
    },
    bonus: "총 6문제 시간분배 필요, 문장력, 어휘력, 거시적 관점 해석, 제시문 활용",
  },
  {
    name: "서강대",
    slug: "sogang",
  ...
  },
  {
    ...
    bonus: "동어반복 피하기, 짧고 간결한 예시답안형 문장",
  },
  {
    name: "성균관대",
    slug: "skku",
  ...
  criteria: {
    ...
    bonus: "보기를 중심으로, 출제 의도에 맞춰 시간 내 완성",
  },
  {
  name: "한양대",
  slug: "hanyang",
  ...
  criteria: {
    ...
    bonus: "논리적 구성보다 명료한 주관·설득력 중시(구체 예증 있으면 가산)",
  },
  {
    name: "홍익대",
    slug: "hongik",
    ...
    bonus: "어휘력, 문장력, 논술은 어렵지 않으나 경쟁률이 높음",
  },
];