...
const DEFAULTS: Testimonial[] = [
  {
    quote:
      "여기서는 제 글이 어느 대학에서 더 유리한지 바로 확인할 수 있어요. 무료 3회 체험만으로도 제 강점이 보여요.",
    author: "정민",
    meta: "수험생",
  },
  {
    quote:
      "일반 첨삭보다 심리적 부담이 적고 속도가 빨라서 좋아요. 디지털이라 패드로 공부하는 저에게 딱이에요.",
    author: "서준",
    meta: "고3",
  },
  {
    quote:
      "학교별 평가 비율에 따라 AI가 점수까지 보여줘서, 어디를 강화해야 할지 명확했습니다.",
    author: "해린",
    meta: "N수생",
  },
  {
    quote:
      "학종보다 강화된 논술 전형 학생들과 공유하기도 편했습니다. 정확하게 분석되어 논술반 지도하기 정말 좋았습니다.",
    author: "김쌤",
    meta: "D여고 국어교사",
  },
];
